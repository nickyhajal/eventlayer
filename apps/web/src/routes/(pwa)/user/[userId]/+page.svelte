  ...
  <div class="mx-auto max-w-7xl pb-28 pt-safe-offset-8 lg:pt-0">
    ...
    <div class="flex flex-col items-center gap-2 pb-6">
      ...
      <div class="flex flex-col text-center">
          ...
          >
            ...
            {#if info("location")}
              <span class="flex items-center gap-0.5 pl-3">
                <Pin
                  class="inline w-4 fill-blue-100 stroke-blue-300 text-stone-600"
                />
                {info("location")}
              </span>
            {/if}
        ...
        {/if}
        {#if info("company")}
          <div class="pb-0 text-sm font-medium text-slate-600">
            {info("company")}
          </div>
        {/if}
      </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      {#if user.proBio}
        <Markdown
          data={user.proBio}
          class="border-t border-slate-200 pr-4 pt-8 text-slate-600"
        />
      {/if}
      <div class="mt-10">
