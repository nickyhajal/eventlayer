...
<Screen
  title="Whale Tank Finalists"
  bigTitle="Whale Tank Finalists"
  ...
  <div class="relative mx-auto -mt-2 max-w-7xl bg-slate-100">
    <div class="mb-8 max-w-2xl mt-16 px-4 sm:px-0">
      <p class="text-lg mb-4">
        The Whale Tank is more than just a competition—it's a festival and a
        problem-solving session to address real-world challenges in clinical
        trials and health innovation.
      </p>
      <p class="text-lg">
        Built to go beyond networking and pitches, Whale Tank equips startups
        with practical, hands-on support and direct feedback from customers,
      ...
      {#each results.filter(({ type }) => showType === "all" || type === showType) as sponsor}
        ...
        <div class="relative z-0 flex flex-col rounded-2xl bg-white p-1">
          ...
          <div class="px-2 pb-2">
            ...
            <div
              class="line-clamp mb-0.5 truncate text-sm font-medium text-slate-600"
            >
              {description || "-"}
            </div>
