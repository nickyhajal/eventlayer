...
export const NotAuthdError = () =>
  error(403, 'You must be authenticated to do that')
...
export const NoPermissionToViewError = () =>
  error(401, `You don't have permission to view that`)