...
{#if !rows?.length}
  <div
    class="mt-6 w-7/12 rounded-xl bg-stone-50 p-6 text-center text-sm text-stone-600"
  >
    {emptyMsg || "No rows yet"}
  </div>
{:else}
  <div
    class="mt-4 overflow-hidden rounded-2xl border border-b-2 border-stone-100"
  >
    <div class="columns">
      <div class="column">
        <div
        ...
        <div class="overflow-hidden rounded-2xl">
                      ...
                      >
                        {#if getCellStringValue(cell).startsWith("userAvatar")}
                          <UserAvatar
                            ...
                            user={JSON.parse(
                              getCellStringValue(cell).replace(
                                "userAvatar:",
                                "",
                              ),
                            )}
                        ...
                        {:else if getCellStringValue(cell).startsWith("readonlyInput:")}
                          <input
                            ...
                            value={getCellStringValue(cell)
                              ...
                              .trim()}
                            class="w-full min-w-[8rem] rounded-md border border-stone-200 bg-white px-2 py-1 text-xs text-stone-600"
                ...
                {#if isExpandedRow(row)}
                  <tr class="bg-white">
                    <td
                      ...
                      class="border-t border-stone-100 px-4 py-0"
                    >
          ...
          <div
            class="flex items-center bg-stone-50 p-3 text-xs font-medium text-stone-500"
          >
            <button
...
{#if csvModalOpen}
  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div
      class="relative z-10 w-full max-w-md rounded-lg border bg-white p-6 shadow-lg"
    >
      ...
      <div class="mb-4">
        ...
        <div
          class="max-h-60 space-y-1.5 overflow-y-auto rounded-md border border-stone-200 p-3"
        >
